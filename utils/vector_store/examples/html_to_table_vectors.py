...
def main():
    ...
    parser = argparse.ArgumentParser(description="Convert HTML to markdown, extract tables, and store in vector DB")
    parser.add_argument("html_file", help="Path to the HTML file to process")
    parser.add_argument("--persist-dir", help="Directory to persist the vector database (default: in-memory)")
    parser.add_argument("--collection", default="html_tables", help="Name of the collection in the vector database")
